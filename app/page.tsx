export default function Home() {
  return (
    <div className="min-h-screen bg-[var(--hp-canvas)] text-[var(--hp-ink)]">
      <div className="h-9 bg-[var(--hp-ink)] text-[var(--hp-on-ink)]">
      ...
      <main className="mx-auto max-w-6xl px-6 py-16 sm:py-24">
        <section className="relative overflow-hidden rounded-[16px] bg-[var(--hp-paper)] border border-[var(--hp-hairline)]">
          <div aria-hidden className="pointer-events-none absolute inset-0">
            ...
            />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,var(--hp-primary-soft),transparent_55%)] opacity-60" />
          </div>
          ...
          <div className="relative px-8 py-14 sm:px-14 sm:py-16">
            ...
            <div className="mt-10">
              <div className="h-1.5 w-full max-w-xl rounded-full bg-[var(--hp-fog)] overflow-hidden border border-[var(--hp-hairline)]">
                <div
                  className="h-full w-full bg-[repeating-linear-gradient(135deg,var(--hp-primary)_0_10px,transparent_10px_20px)] motion-safe:animate-[hp-scan_1.6s_linear_infinite]"
                  aria-hidden
                />
              </div>
        ...
        <section className="mt-10 rounded-[16px] bg-[var(--hp-ink)] text-[var(--hp-on-ink)] px-8 py-10 sm:px-14">
